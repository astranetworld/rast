...
use reth_primitives::{
    eip4844::calculate_excess_blob_gas, proofs, Block, BlockBody, BlockHash, BlockHashOrNumber, BlockNumber, BlockWithSenders, Bloom, Header, Requests, SealedBlock, SealedHeader, TransactionSigned, Verifiers,Rewards, Withdrawals, B256, U256
};
...
impl StorageInner {
        ...
        Provider: StateProviderFactory,
    {
        ...
        let body = BlockBody { transactions: body, ommers, withdrawals, requests ,verifiers,rewards};
